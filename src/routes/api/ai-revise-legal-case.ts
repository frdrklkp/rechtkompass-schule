    ...
    handlers: {
      POST: async ({ request }) => {
        ...
        const system = [
          ...
          "NICHT NUR DIE BEANSTANDETEN STELLEN: gehe ZUSÄTZLICH proaktiv JEDES Element aller Felder nach denselben Maßstäben durch (trägt die Quelle diese Aussage wörtlich? ist das Label gerechtfertigt? Schriftform/Frist/Zuständigkeit gedeckt?) - die Prüfbefunde sind Beispiele, keine vollständige Liste. Erfahrung: Fälle fallen wiederholt durch, weil nur die explizit gemeldeten Punkte saniert wurden und der nächste Prüfdurchlauf gleichartige Mängel an anderen Elementen findet.",
