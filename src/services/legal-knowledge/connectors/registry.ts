...
export const OFFICIAL_SOURCES: OfficialSourceDefinition[] = [
  ...
  },
  {
    id: "bgb",
    label: "BGB (Auszug)",
    description: "Bürgerliches Gesetzbuch - Auszug: Geschäftsfähigkeit, Haftung/Aufsichtspflicht, elterliche Sorge",
    defaultUrl: "https://www.gesetze-im-internet.de/bgb/BJNR001950896.html",
    parserId: "bgb",
    hosts: ["gesetze-im-internet.de", "www.gesetze-im-internet.de"],
    maxPages: 5,
    maxDepth: 0,
  },
  {
    id: "stgb",
    label: "StGB (Auszug)",
    description: "Strafgesetzbuch - Auszug: Beleidigung, heimliche Aufnahmen, Körperverletzung, Nötigung, Sachbeschädigung",
    defaultUrl: "https://www.gesetze-im-internet.de/stgb/BJNR001270871.html",
    parserId: "stgb",
    hosts: ["gesetze-im-internet.de", "www.gesetze-im-internet.de"],
    maxPages: 5,
    maxDepth: 0,
  },
  {
    ...
    description: "Gesetzliche Unfallversicherung - Auszug: Schülerunfallversicherung, Haftungsbeschränkung",
    defaultUrl: "https://www.gesetze-im-internet.de/sgb_7/BJNR125410996.html",
    parserId: "sgb-7",
    hosts: ["gesetze-im-internet.de", "www.gesetze-im-internet.de"],
    maxPages: 5,
    maxDepth: 0,
  },
  {
    id: "juschg",
    label: "JuSchG (Auszug)",
    description: "Jugendschutzgesetz - Auszug: Alkohol/Rauchen in der Öffentlichkeit (Klassenfahrten)",
    defaultUrl: "https://www.gesetze-im-internet.de/juschg/BJNR273000002.html",
    parserId: "juschg",
    hosts: ["gesetze-im-internet.de", "www.gesetze-im-internet.de"],
    maxPages: 5,
    maxDepth: 0,
