    ...
    handlers: {
      POST: async ({ request }) => {
        ...
        const user = {
          ...
          hinweis:
            "Fülle möglichst alle Felder aus. Checkliste 5–10 Punkte, Doku 3–7 Punkte, FAQ 4–8 Q&A, Praxistipp MINDESTENS 5 und maximal 8 konkrete fallbezogene Do's (jede als eigene Zeile mit '- '), Typische Fehler 3–6 Don'ts. Zuständigkeiten (Lehrkraft, Klassenleitung, ggf. Abteilungsleitung/Ausbildungskoordination oder Schulleitung - je nach Ampel-Einstufung) klar benennen. Rechtsgrundlagen: Ziel mindestens 3 belastbare Treffer, keine künstliche Auffüllung, kein § 53 SchulG NRW ohne fachlichen Bezug (Fehlverhalten, Ordnungsmaßnahme, Verhältnismäßigkeit, Ausschluss).",
        };
